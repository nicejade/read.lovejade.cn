import{g as t,m as s,e as a,c as o,b as n,u as c}from"./index-d7kNql4x.js";const r=`
...
- [X（Twitter）](https://x.com/MarshalXuan)`,m={id:"about",class:"flex flex-row justify-center w-full max-w-xl px-4"},h=["innerHTML"],p=t({__name:"About",setup(i){let e=s.parse(r,{breaks:!0});return(l,u)=>(a(),o("div",m,[n("div",{class:"my-10 md:my-4 markdown text-brand",innerHTML:c(e)},null,8,h)]))}});export{p as default};
