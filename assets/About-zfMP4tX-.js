import{g as t,m as s,e as a,c as o,b as n,u as r}from"./index-SouaRE_O.js";const c=`
...
最后，非常喜欢的作家王小波先生，在《一只特立独行的猪》中写过一段非常喜欢的话，在此分享，与诸君共勉：**我来这个世界不是为了结婚生子繁衍后代，而是为了看这个世界花怎么开，水怎么流，太阳何时升起，夕阳如何落下**。我活在世上，无非想明白些道理，遇见些有趣的事；生命是一场偶然，我在其中寻找因果。`,l={class:"flex flex-row justify-center w-full max-w-xl px-4"},d=["innerHTML"],i=t({__name:"About",setup(m){let e=s.parse(c,{breaks:!0});return(p,u)=>(a(),o("div",l,[n("div",{class:"my-10 md:my-4 markdown-body text-brand",innerHTML:r(e)},null,8,d)]))}});export{i as default};
